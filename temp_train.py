...
image_path = r'D:\my_phd\on_git\Stage5\a_128.jpg'
...
image.show()
gaussian_img = AddGaussianNoise(mean=random.uniform(0.5, 1.5), variance=0.8, amplitude=random.uniform(0, 35))(image)
gaussian_img.show()
