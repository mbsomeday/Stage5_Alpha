...
image_pepper = AddPepperNoise(0.99, 1.0)(image)
image_gau = AddGaussianNoise(mean=random.uniform(0.5, 1.5), variance=0.8, amplitude=random.uniform(0, 35))(image)
# image_pepper.show()

diff_p = ImageChops.subtract(image, image_pepper)
diff_g = ImageChops.subtract(image, image_gau)
