...
def vgg16_bn(num_cls, pretrained=None):
    model = VGG(create_features_modules(models_param['vgg16'], batch_norm=True), num_cls)
    if pretrained:
        # pedCls_weights_path = r'D:\my_phd\Model_Weights\Stage4\Baseline\vgg16bn-D1-014-0.9740.pth'
        checkpoints = torch.load(pretrained, map_location='cpu')
